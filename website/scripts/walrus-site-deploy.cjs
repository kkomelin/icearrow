...
/**
 * The script publishes or updates the app on Walrus Sites.
 * After publishing the app, site object ID is copied to .env.local, which is used later to update the app on Walrus Sites.
 * 
 * This script has been borrowed from kkomelin/sui-dapp-starer (MIT License) and adapted to this project.
 */
